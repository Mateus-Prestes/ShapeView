        ...
        <div class="entrada">
          <div class="seleçao">    
            <ul>
                <li>
                    <fieldset class="arq">
                        <legend class="central">Upload</legend>
                        <form name="form">
                            <input 
                                class="arvo" 
                                type="file" 
                ...
                <li>
                    <fieldset class="arq">
                        <legend class="central">Download</legend>
                        <form name="form">
                            <legend class="central">Selecione a pasta de destino</legend>

                            <legend class="central">Selecione o arquivo</legend>
