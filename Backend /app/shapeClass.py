...
class ShapeClass():
    ...
    def conect(self, host, port, database, user, password):##conexão
        try:
    ...
    def getTablesDB(self): ##tabelas do DB
    ...
    def getColumns(self, tableName): ##colunas das tabela
    ...
    def upload_in_DB(self, tableName, shp_adress, list_columnsDB, list_columnsSHP): ##Upload do shapefile no banco
